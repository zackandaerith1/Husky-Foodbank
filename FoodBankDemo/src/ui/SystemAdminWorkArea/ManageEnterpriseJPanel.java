...
public class ManageEnterpriseJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        if (enterpriseJTable.getColumnModel().getColumnCount() > 0) {
            enterpriseJTable.getColumnModel().getColumn(3).setMinWidth(0);
            enterpriseJTable.getColumnModel().getColumn(3).setPreferredWidth(0);
            enterpriseJTable.getColumnModel().getColumn(3).setMaxWidth(0);
            enterpriseJTable.getColumnModel().getColumn(4).setMinWidth(0);
            enterpriseJTable.getColumnModel().getColumn(4).setPreferredWidth(0);
        ...
        Deletedbtn.setBackground(new java.awt.Color(94, 138, 117));
        Deletedbtn.setFont(new java.awt.Font("Yu Gothic UI", 1, 14)); // NOI18N
        Deletedbtn.setForeground(new java.awt.Color(43, 71, 92));
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Enterprise Added!", "Warning", JOptionPane.WARNING_MESSAGE);
    ...
    private void DeletedbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeletedbtnActionPerformed
        ...
        Enterprise e = (Enterprise) enterpriseJTable.getValueAt(selectedRow, 3);
        Network n = (Network) enterpriseJTable.getValueAt(selectedRow, 4);
