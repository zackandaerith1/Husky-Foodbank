...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        if (enterprise.getEnterpriseType().toString().equals("Shelter")) {
            UserAccount account = enterprise.getUserAccountDirectory().createUserAccount(username, password, employee, new ShelterAdminRole());
        ...
        JOptionPane.showMessageDialog(null, "Enterprise Account Added", "Warning", JOptionPane.WARNING_MESSAGE);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        for (Network network : ecosystem.getNetworkList()) {
            for (Enterprise enterprise : network.getEnterpriseDirectory().getEnterpriseList()) {
                enterprise.getUserAccountDirectory().removeAccount(account);
            }
        }
